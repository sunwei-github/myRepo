...
public class MessageConstant {
    ...
    public static final String GET_MEMBER_SEX_SUCCESS = "查询会员性别数据成功";
    public static final String GET_MEMBER_SEX_FAIL = "查询会员性别数据失败";
    public static final String GET_MEMBER_AGE_SUCCESS = "查询会员年龄数据成功";
    public static final String GET_MEMBER_AGE_FAIL = "查询会员年龄数据失败";
    ...
    public static final String QUERY_LINK_PERMISSION_SUCCESS = "查询关联的权限成功";
    public static final String QUERY_LINK_PERMISSION_FAIL = "查询关联的权限失败";
    public static final String QUERY_LINK_MENU_SUCCESS = "查询关联的菜单成功";
    public static final String QUERY_LINK_MENU_FAIL = "查询关联的菜单失败";
    public static final String QUERY_ALLPERMISSION_SUCCESS = "查询所有权限成功";
    public static final String QUERY_ALLPERMISSION_FAIL = "查询所有权限失败";
    public static final String QUERY_ALLMENU_SUCCESS = "查询所有菜单成功";
    public static final String QUERY_ALLMENU_FAIL = "查询所有菜单失败";
    ...
    public static final String QUERY_ALL_ROLE_SUCCESS = "查询所有角色成功";
    public static final String QUERY_ALL_ROLE_FAIL = "查询所有角色失败";
    ...
    public static final String QUERY_SETMEAL_DETAIL_SUCCESS = "查询套餐详情数据成功";
    public static final String QUERY_SETMEAL_DETAIL_FAIL = "查询套餐详情数据失败";
}
